-- Curves and animations, matched to binnewbs/arch-hyprland's UserAnimations.conf
...
hl.curve("nice",       { type = "bezier", points = { {0, 2},       {0.5, -1}    } }) -- clamped from rice's {0,6.9},{0.5,-4.20}; Hyprland limits bezier points to [-1,2]
